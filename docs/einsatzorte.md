...
In der Feldliste können Sie bestehende Felder über **Bearbeiten** ändern. Mit **Löschen** entfernen Sie ein Feld.

Löschen Sie Felder nur, wenn sie nicht mehr benötigt werden. Für alte Dokumentationen bleiben gespeicherte Anwendungsdaten in der Historie erhalten.

## Häufige Probleme

## Feld erscheint nicht in der Dokumentation

Prüfen Sie, ob dem Feld die richtige Kultur zugeordnet ist. In der Dokumentation werden nach der Kulturwahl nur passende Felder angezeigt.

## Keine Berechtigung zum Anlegen

Wenn **+ Neues Feld** nicht sichtbar ist, fehlen Ihnen wahrscheinlich Schreibrechte. Wenden Sie sich an einen Administrator.

## Fläche oder Einheit ist falsch

Bearbeiten Sie das Feld und korrigieren Sie Fläche und Einheit. Neue Dokumentationen verwenden danach die aktualisierten Werte.
