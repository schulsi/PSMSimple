...
## Bewegungshistorie nutzen

Im Reiter **Bewegungshistorie** sehen Sie die letzten Buchungen. Über **Anzahl Einträge** können Sie auswählen, ob 50, 200 oder 500 Einträge angezeigt werden.
...
## Ein Mittel fehlt im Lager

Prüfen Sie, ob das Mittel im Bereich **Pflanzenschutzmittel** gespeichert ist.

## Bestand ist negativ

Prüfen Sie die Bewegungshistorie. Häufig fehlt ein Einkauf oder eine Korrekturbuchung, oder eine Anwendung wurde mit zu hoher Menge dokumentiert.

## Keine Buchung möglich

Wenn **+ Buchung** nicht sichtbar ist, fehlen Ihnen wahrscheinlich Schreibrechte.
