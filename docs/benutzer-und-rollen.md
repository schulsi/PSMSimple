...
Prüfen Sie, ob Registrierung in den Einstellungen erlaubt ist.

## Rolle lässt sich nicht ändern

Prüfen Sie, ob Sie Admin-Rechte haben. Die eigene Admin-Rolle kann nicht entfernt werden.

## Benutzer kann nicht gelöscht werden

Der aktuell angemeldete Benutzer kann nicht gelöscht werden. Melden Sie sich mit einem anderen Admin-Konto an.
