...
## Exportbutton ist deaktiviert

Mindestens eine Pflichtangabe fehlt. Prüfen Sie die Dokumentationsseite und achten Sie auf den Hinweis unterhalb der Buttons.

## Download startet nicht

Prüfen Sie, ob der Browser Downloads blockiert oder ob ein Popup-/Download-Schutz aktiv ist. Versuchen Sie danach den Download erneut.

## PDF wird nicht heruntergeladen

In manchen Server-Konfigurationen kann die PDF-Datei serverseitig abgelegt werden. Prüfen Sie die Systemeinstellung zum Export-Verhalten oder fragen Sie einen Administrator.
