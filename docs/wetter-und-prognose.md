...
Die Grenzwerte werden in den **Einstellungen** gepflegt. Dazu gehören:
...
Die Prognose ist eine Entscheidungshilfe. Prüfen Sie vor der tatsächlichen Anwendung immer die fachlichen und rechtlichen Anforderungen.

## Häufige Probleme

## Kein passendes Zeitfenster gefunden

Die aktuellen Wetterbedingungen erfüllen die Grenzwerte nicht. Prüfen Sie die Alternativen, erweitern Sie den Zeitraum oder kontrollieren Sie die Standardwerte in den Einstellungen.

## Orte können nicht geladen werden

Prüfen Sie, ob Orte vorhanden sind und ob die Verbindung zum Server funktioniert.
