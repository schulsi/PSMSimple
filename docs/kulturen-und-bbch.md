...
## BBCH hinzufügen ist deaktiviert

Speichern Sie die Kultur zuerst. BBCH-Codes können erst sinnvoll einer bereits gespeicherten Kultur zugeordnet werden.

## BBCH-Code erscheint nicht bei der Dokumentation

Prüfen Sie, ob der BBCH-Code bei der richtigen Kultur gespeichert wurde. Öffnen Sie die Kultur über **Bearbeiten** und kontrollieren Sie die BBCH-Tabelle.

## Kultur erscheint nicht bei einem Feld

Prüfen Sie, ob die Kultur gespeichert wurde. Danach können Sie sie im Bereich **Felder** einem Feld zuordnen.
