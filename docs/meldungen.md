...
Wählen Sie eine Meldung aus und klicken Sie auf **Bearbeiten**. Ändern Sie die gewünschten Angaben und speichern Sie die Meldung erneut.

## Meldung abschließen

Setzen Sie den Status auf **Erledigt**, wenn die Meldung bearbeitet wurde. Für verworfene oder nicht relevante Einträge kann **Verworfen** verwendet werden.

## Häufige Probleme

## Keine Meldungen sichtbar

Prüfen Sie die Filter. Möglicherweise ist ein Status, Typ oder Feld ausgewählt, der keine Treffer liefert.

## Kamera ist nicht verfügbar

Die Kamera hängt vom Gerät, Browser und den Berechtigungen ab. Nutzen Sie alternativ **Galerie auswählen**.

## Meldung lässt sich nicht bearbeiten

Wenn Bearbeiten oder Löschen nicht sichtbar ist, fehlen Ihnen wahrscheinlich Schreibrechte.
