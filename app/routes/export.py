...
def preview_json():
    ...
    logger.info(f"Preview generated by user: {current_user.username} from IP: {request.remote_addr} with payload: {payload}")
...
def export_json():
    ...
    logger.info(f"JSON export generated by user: {current_user.username} from IP: {request.remote_addr} with payload: {payload}")
...
def export_pdf():
    ...
    logger.info(f"PDF export generated by user: {current_user.username} from IP: {request.remote_addr} with payload: {payload}")
    return jsonify({"ok": True, "filename": filename})